...
def display_top_five_marks(marks):
    if len(marks) < 5:
        print("There are fewer than five marks to display.")
    else:
...
####################### DEFALT values are given selction_sort ############################################
marks=[12,34,2,67,24]

Selection_Sort(marks)
print("element after the selection:")
print(marks)
###################### defalt values for bubble sort################################################

marks=[12,34,2,45,88]

Bubble_Sort(marks)
print("element after the bubble_sort:")
print(marks)
######## main function*****************
# Main
